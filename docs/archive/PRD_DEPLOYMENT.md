# Product Requirements Document: ORCHESTRATOR: Deployment
...
**TASK_007** [HIGH]: [Helm Chart Deployment](#helm-chart-deployment)
...
**TASK_039** [HIGH]: **Step 3**: Increase to 25% traffic (5 min pause)
